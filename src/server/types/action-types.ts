 ...
 */
export type InferActionInput<T extends GenericAction> = T extends (
  ...args: infer P
) => any
 ...
 */
export type InferActionOutput<T extends GenericAction> = T extends (
  ...args: any[]
) => Promise<AsyncState<infer R, any>>
  ? R
  : never;
 ...
 */
export type InferActionError<T extends GenericAction> = T extends (
  ...args: any[]
) => Promise<AsyncState<any, infer E>>
  ? E
  : never;
